...
export function assertPeloponnesianEqual(actual: AnyNumber, expect: AnyNumber) {
    return assertNumberEqual(actual, expect, PELO_DECIMALS);
}

export function toPeloponnesian(num: AnyNumber) {
    return shiftNumber(num, PELO_DECIMALS);
}
