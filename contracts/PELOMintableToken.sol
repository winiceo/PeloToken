...
contract PELOMintableToken is PELOToken, MintableToken,BurnableToken {
  using SafeMath for uint256;
	 ...
	 */
	function PELOMintableToken(uint256 initialSupply, uint256 cap) {
	...
	function claimTokens(address _token) onlyOwner {
		...
		PELOMintableToken token = PELOMintableToken(_token);
