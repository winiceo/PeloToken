...
const main = async () => {
    ...
    var contractAddress = "0x27b34E7FB4359C69A76126C846f388FB59681F24";
    var contract = new web3.eth.Contract(abiArray, contractAddress, {
        from: myAddress
    });
    // How many tokens do I have before sending?
    var balance = await contract.methods.balanceOf("0xfd21AD27B120151B93f550FCF12942E5EcF8852d").call();
    console.log(`Balance before send: ${financialMfil(balance)} MFIL\n------------------------`);



    var cc=await contract.methods.approve(destAddress,new BigNumber(3000*1e18)).call()
    var bb    =await contract.methods.claimTokens(destAddress).call();
    var bc    =await contract.methods.pause().call();

            console.log(bc)
     //console.log(`Balance before send: ${financialMfil(bc)} MFIL\n------------------------`);

    // contract.approve(destAddress, 3000000*1e18, { from: myAddress })
